# monocular-depth-unity
 ...
 This project **includes** the correct .onnx model that works well with Barracuda. You can always download the model from its official [source](https://github.com/intel-isl/MiDaS/releases/download/v2_1/model-small.onnx).
